...
router.post('/addArticles', async(req, res) => {
    const { titlearticle, textarticle, autorarticle, categoryarticle, id_user } = req.body;
    const newArticle = { titlearticle, textarticle, autorarticle, categoryarticle, id_user };
