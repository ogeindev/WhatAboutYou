...
router.post('/addForumpost', async(req, res) => {
    const { titleforumpost, textforumpost, autorforumpost, categoryforumpost, tagsforumpost, id_user } = req.body;
    const newForumpost = { titleforumpost, textforumpost, autorforumpost, categoryforumpost, tagsforumpost, id_user };
